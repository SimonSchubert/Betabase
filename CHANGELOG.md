...
### Features
- Expanded gym map with many new cities and climbing gyms
- Refreshed athlete YouTube video feed

### Improvements
- Improved gym map pin rendering across platforms
...
### Improvements
- Migrated the app to Compose Multiplatform (adds iOS, desktop, and Web targets)
- Improved UI performance
- Polished UI/UX, including launcher icon refinements
- Upgraded dependencies
