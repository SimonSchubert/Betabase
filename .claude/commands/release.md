Perform a release for Braincup. Bump type argument: $ARGUMENTS (default: patch).
...
- CI/workflow changes (e.g. "Update release.yml", "Fix CI")
...
- Each line should be a concise description, similar in style to existing entries like "Add missing localizations"
...
- Create annotated tag: `git tag -a v{new} -m "Release v{new}"`
- Push commit and tag to origin: `git push origin master --follow-tags`
